...
|---|---|---|---|---|---|---|
| task_01 | Persist the full shortcut map | US-08 | backend | high | [] | pending |
| task_02 | Honor remapped chords on loop and chrome paths | US-02 | backend | high | [task_01] | pending |
